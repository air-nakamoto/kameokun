...
function buildStubHint(): NakamotoHintOutput {
  return {
    narration:
      '🐢「えーっと、ここまでよぉ頑張ってますね〜！会話の感じからすると、もうちょっと深掘りできそうな方向がありそうですよ。一緒に整理していきましょか」',
    important_points: [
      'まだ会話が始まったばっかりですけど、相談者さんの困りごとの輪郭は見えてきましたね',
    ],
    underexplored_points: [
      '相談者さん以外の登場人物にも、話を聞いてみる手がありますよ〜',
      '「いつから」「どんなきっかけで」みたいな時系列の話も、案外大事だったりします',
    ],
